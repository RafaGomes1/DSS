...
public class MotorGasolina extends Veiculo{

    private int motorCombustaoPotencia;

    public MotorGasolina(String matricula, String modelo, String marca, InformacaoDAO fichaVeiculo, String tipoMotor, int motorCombustaoPotencia) {
    ...
    public boolean equals(Object o) {
        ...
        MotorGasolina c = (MotorGasolina) o;
    ...
    public MotorGasolina clone() {
        return new MotorGasolina(super.getMatricula(),super.getModelo(),super.getMarca(),super.getFichaVeiculo(),super.getTipoMotor(),this.motorCombustaoPotencia);
    }
